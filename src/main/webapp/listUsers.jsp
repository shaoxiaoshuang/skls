...
<%@ page import="org_sxs.pojo.Users" %><%--
...
<table width="490" border="0" align="center">
    ...
    <tr>
        <td align="center"> 【<a href="all.do">用户管理</a>】【<a href="listNews.html">新闻管理</a>】【商铺管理】【论坛管理】【<a
    ...
    <tr>
        <td>
            <table width="100%" border="1" align="center" bordercolor="#660033" bgcolor="#99CCCC" cellspacing="1">
                ...
                <%
                    //获得数据
                    List<Users> list = (List<Users>) request.getAttribute("lists");
                    //循环遍历
                    for (Users user : list) {
                ...
                <tr align="center">
                    <td width="25%"><a
                            href="userInfo.jsp?id=<%=user.getId()%>&uname=<%=user.getUsername()%>&upwd=<%=user.getPassword()%>"><%=user.getId()%>
                    </a></td>
                    <td width="40%"><%=user.getUsername()%>
                    </td>
                    <td><%=user.getPassword()%>
                    </td>
                </tr>
